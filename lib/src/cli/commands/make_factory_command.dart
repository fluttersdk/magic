...
///
/// ```bash
/// artisan make:factory User         # → UserFactory in user_factory.dart
/// artisan make:factory UserFactory  # Same result — no double-suffix
/// ```
class MakeFactoryCommand extends ArtisanGeneratorCommand {
  ...
  /// the full `Factory`-suffixed class name, not the raw user input.
  @override
  ...
  Map<String, String> getReplacements(String name) {
    ...
    return {'{{ modelName }}': modelName, '{{ snakeName }}': snakeName};
  }
}
