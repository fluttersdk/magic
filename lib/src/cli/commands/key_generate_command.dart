...
class KeyGenerateCommand extends ArtisanCommand {
  @override
  ...
  Future<int> handle(ArtisanContext ctx) async {
    ...
    if (ctx.input.hasOption('show')) {
      ctx.output.info('APP_KEY=$keyWithPrefix');
      return 0;
    }
    ...
    ctx.output.success('Application key set successfully.');
    ctx.output.writeln('APP_KEY               $keyWithPrefix');
    return 0;
  }
