...
- Dart >=3.4.0, Flutter >=3.22.0 — use modern patterns (records, switch expressions, strict null safety)
...
- `analysis_options.yaml` excludes `plugins/**` — each plugin runs own analyzer
