...
| `README.md` | Version numbers in badges or install examples |
...
### Phase 4: Doc & AGENTS.md Sync

Check these files for any content that needs updating:

1. **README.md** — Version badges, install examples, feature list accuracy
2. **AGENTS.md** — Root and child AGENTS.md files if facade APIs, gotchas, or architecture changed
3. **doc/** — Any version-specific content or outdated code examples
...
2. **Creates the git tag** (e.g. `1.0.0-alpha.2`)
